...
class Scanner:
    ...
    def _build_opportunity(self, a: ExchangeData, b: ExchangeData,
        ...
        net_pct = adj_diff - CONFIG["ROUND_TRIP_COST"] - price_gap_pct * 0.5
        firing_times = []
        ...
        if 0 < ttf_min < 9999:
            ...
            timing_bonus = 1.0
        score = max(net_pct, 0.0) * freq_bonus * timing_bonus - price_gap_pct * 0.3
        ...
        if price_gap_pct > CONFIG["PRICE_GAP_SKIP"]:
            eligible = False
            reasons.append("price gap too large")
        if net_pct <= 0:
            eligible = False
